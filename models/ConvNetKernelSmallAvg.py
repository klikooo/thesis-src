...
class ConvNetKernelSmallAvg(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size=8):
        super(ConvNetKernelSmallAvg, self).__init__()
    ...
    def name(self):
        return "{}_k{}".format(ConvNetKernelSmallAvg.basename(), self.kernel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}".format(ConvNetKernelSmallAvg.basename(), args['kernel_size'])

    @staticmethod
    def basename():
        return ConvNetKernelSmallAvg.__name__
    ...
    def load_model(file):
        ...
        model = ConvNetKernelSmallAvg(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return ConvNetKernelSmallAvg(out_shape=args['n_classes'],
