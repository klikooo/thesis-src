...
class KB(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}".format(KB.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KB.basename(), args['kernel_size'], args['channel_size'])
    ...
    def load_model(file):
        ...
        model = KB(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KB(out_shape=args['n_classes'],
