...
class KernelBigSmallAvg(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size):
        super(KernelBigSmallAvg, self).__init__()
        ...
        self.mp1 = nn.AvgPool1d(self.avg_pool).to(device)
        ...
        self.mp2 = nn.AvgPool1d(2).to(device)
        ...
        self.mp3 = nn.AvgPool1d(2).to(device)
        num_features = int(num_features / 2)
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigSmallAvg.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigSmallAvg.basename(), args['kernel_size'], args['channel_size'])

    @staticmethod
    def basename():
        return KernelBigSmallAvg.__name__
    ...
    def load_model(file):
        ...
        model = KernelBigSmallAvg(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigSmallAvg(out_shape=args['n_classes'],
