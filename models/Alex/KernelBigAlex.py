...
class KernelBigAlex(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigAlex.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigAlex.basename(), args['kernel_size'], args['channel_size'])

    @staticmethod
    def basename():
        return KernelBigAlex.__name__
    ...
    def load_model(file):
        ...
        model = KernelBigAlex(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigAlex(out_shape=args['n_classes'],
