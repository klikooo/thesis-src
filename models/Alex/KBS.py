...
class KBS(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}".format(KBS.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KBS.basename(), args['kernel_size'], args['channel_size'])
    ...
    def load_model(file):
        ...
        model = KBS(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KBS(out_shape=args['n_classes'],
