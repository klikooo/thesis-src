...
class KBS3(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}".format(KBS3.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KBS3.basename(), args['kernel_size'], args['channel_size'])

    @staticmethod
    def basename():
        return KBS3.__name__
    ...
    def load_model(file):
        ...
        model = KBS3(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KBS3(out_shape=args['n_classes'],
