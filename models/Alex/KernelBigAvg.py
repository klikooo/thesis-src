...
class KernelBigAvg(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigAvg.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigAvg.basename(), args['kernel_size'], args['channel_size'])

    @staticmethod
    def basename():
        return KernelBigAvg.__name__
    ...
    def load_model(file):
        ...
        model = KernelBigAvg(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigAvg(out_shape=args['n_classes'],
