...
class VGGNumLayers4(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}_l{}_m{}".format(VGGNumLayers4.basename(),
                                           self.kernel_size, self.channel_size, self.num_layers,
                                           self.max_pool)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}_l{}_m{}".format(VGGNumLayers4.basename(), args['kernel_size'],
                                           args['channel_size'], args['num_layers'], args['max_pool'])

    @staticmethod
    def basename():
        return VGGNumLayers4.__name__
    ...
    def load_model(file):
        ...
        model = VGGNumLayers4(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return VGGNumLayers4(out_shape=args['n_classes'],
