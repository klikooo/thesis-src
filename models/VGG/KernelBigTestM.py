...
class KernelBigTestM(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size):
        super(KernelBigTestM, self).__init__()
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigTestM.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def basename():
        return KernelBigTestM.__name__

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigTestM.basename(), args['kernel_size'],
                                   args['channel_size'])
    ...
    def load_model(file):
        ...
        model = KernelBigTestM(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigTestM(out_shape=args['n_classes'],
