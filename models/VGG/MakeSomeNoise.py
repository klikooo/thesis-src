...
class MakeSomeNoise(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size):
        ...
        self.conv7_channels = self.conv5_channels       # 128
        self.conv8_channels = self.conv5_channels * 2   # 256
        self.conv9_channels = self.conv5_channels       # 256
        self.conv10_channels = self.conv5_channels      # 256
