...
class VGGNumLayers(nn.Module):
    ...
    def name(self):
        return "{}_k{}_c{}_l{}".format(VGGNumLayers.basename(),
                                       self.kernel_size, self.channel_size, self.num_layers)

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}_l{}".format(VGGNumLayers.basename(), args['kernel_size'],
                                       args['channel_size'], args['num_layers'])

    @staticmethod
    def basename():
        return VGGNumLayers.__name__
    ...
    def load_model(file):
        ...
        model = VGGNumLayers(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return VGGNumLayers(out_shape=args['n_classes'],
