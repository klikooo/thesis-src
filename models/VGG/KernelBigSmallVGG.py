...
class KernelBigSmallVGG(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size):
        super(KernelBigSmallVGG, self).__init__()
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigSmallVGG.basename(), self.kernel_size, self.channel_size)
    ...
    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigSmallVGG.basename(), args['kernel_size'],
                                   args['channel_size'])
    ...
    def load_model(file):
        ...
        model = KernelBigSmallVGG(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigSmallVGG(out_shape=args['n_classes'],
