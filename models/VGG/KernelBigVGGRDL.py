...
class KernelBigVGGRDLM(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size):
        super(KernelBigVGGRDLM, self).__init__()
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigVGGRDLM.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def basename():
        return KernelBigVGGRDLM.__name__

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigVGGRDLM.basename(), args['kernel_size'],
                                   args['channel_size'])
    ...
    def load_model(file):
        ...
        model = KernelBigVGGRDLM(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigVGGRDLM(out_shape=args['n_classes'],
