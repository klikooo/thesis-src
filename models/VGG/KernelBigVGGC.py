...
class KernelBigVGGC(nn.Module):
    def __init__(self, input_shape, out_shape, kernel_size, channel_size):
        ...
        self.conv3_channels = self.conv2_channels
    ...
    def name(self):
        return "{}_k{}_c{}".format(KernelBigVGGC.basename(), self.kernel_size, self.channel_size)

    @staticmethod
    def basename():
        return KernelBigVGGC.__name__

    @staticmethod
    def save_name(args):
        return "{}_k{}_c{}".format(KernelBigVGGC.basename(), args['kernel_size'],
                                   args['channel_size'])
    ...
    def load_model(file):
        ...
        model = KernelBigVGGC(input_shape=checkpoint['input_shape'],
    ...
    @staticmethod
    def init(args):
        return KernelBigVGGC(out_shape=args['n_classes'],
