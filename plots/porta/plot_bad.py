...
if __name__ == "__main__":
    ge_x, ge_y, data = do(40000, 2, util.DataSet.KEYS_1B)
    fig, fig_acc, fig_loss = create_plots(ge_x, ge_y, data)
    fig.savefig("/media/rico/Data/TU/thesis/report/img/porta/ge_non_norm.pdf")
    fig_acc.savefig("/media/rico/Data/TU/thesis/report/img/porta/acc_non_norm.pdf")
    fig_loss.savefig("/media/rico/Data/TU/thesis/report/img/porta/loss_non_norm.pdf")

    ge_x, ge_y, data = do(39999, '', util.DataSet.KEYS)
    fig, fig_acc, fig_loss = create_plots(ge_x, ge_y, data)
    fig.savefig("/media/rico/Data/TU/thesis/report/img/porta/ge_norm.pdf")
    fig_acc.savefig("/media/rico/Data/TU/thesis/report/img/porta/acc_norm.pdf")
    fig_loss.savefig("/media/rico/Data/TU/thesis/report/img/porta/loss_norm.pdf")
